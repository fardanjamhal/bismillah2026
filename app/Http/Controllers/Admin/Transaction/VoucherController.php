...
class VoucherController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $memberCategories = $voucher->memberCategories;
    ...
    public function update(VoucherRequest $request, $id)
    {
        try {
            ...
            return redirect(route('admin.vouchers.index') . (!empty($queryString) ? '?'.$queryString : ''));
    ...
    public function changeStatus(Request $request, $id)
    {
        try {
            ...
            $this->voucherRepository->find($id)->update(['is_active' => $request->is_active]);
