...
class LessonController extends Controller
{
    ...
    {
        Session::put('queryStringLessons', $request->getQueryString());
    ...
    public function update(LessonRequest $request, $id)
    {
        try {
            ...
            $queryString = Session::get('queryStringLessons');
            return redirect(route('admin.lessons.index') . (!empty($queryString) ? '?'.$queryString : ''));
    ...
    public function changeStatus(Request $request, $id)
    {
        try {
            ...
            $this->lessonRepository->find($id)->update(['development_status' => $request->development_status]);
    ...
    public function getExam($lessonId)
    {
        return (new ExamRepository())->getAllByLesson($lessonId);
    }
}
