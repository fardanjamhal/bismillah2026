<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Pembelian {{ type }}</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pembelian {{ type }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card border-top border-0 border-3 border-primary">
                            <div class="card-header">
                                <div class="d-lg-flex align-items-center">
                                    <h6>Konfirmasi Pembayaran {{ type }}</h6>
                                    <div class="ms-auto">
                                        <Link :href="`/user/transactions/${transaction.id}`" class="btn btn-primary btn-sm mt-2 mt-lg-0">Kembali</Link>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" v-model="form.total_payment" :class="{ 'is-invalid': errors.total_payment }" placeholder="Jumlah Transfer" min="0">
