                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" v-model="form.question" :class="{ 'is-invalid': errors.question }" placeholder="Pertanyaan">
                        ...
                        <div class="col-12">
                            ...
                            <ckeditor :editor="editor" v-model="form.answer" :config="editorConfig" lass="form-control" :class="{ 'is-invalid': errors.answer }"></ckeditor>
