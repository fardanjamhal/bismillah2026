<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Tambah Section Course</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Section Course</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                // send data to server
                Inertia.post(`/admin/courses/${props.course.id}/course-sections`, {
