<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Tryout</title>
    </Head>
    <!--start page wrapper -->
            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label">Kategori Member<i><b>(Khusus untuk Membership Bulanan, jika dikosongkan maka akan menjadi gratis)</b></i></label>
                            <multiselect
                        ...
                        <div class="col-12">
                            <label class="form-label">Judul Tryout</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Deskripsi Tryout</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Tipe Tryout</label>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 2">
                            <label class="form-label">Navigasi Antar Tes</label>
                            <select v-model="form.exam_group_navigation_mode" :class="{ 'is-invalid': errors.exam_group_navigation_mode }" class="form-select">
                                <option value="">[ Pilih ]</option>
                                <option value="1">Manual - Peserta dapat memilih dan memulai tes berikutnya secara mandiri setelah menyelesaikan tes saat ini</option>
                                <option value="2">Otomatis - Peserta akan langsung diarahkan ke tes berikutnya secara otomatis setelah menyelesaikan setiap tes</option>
                            </select>
                            <div v-if="errors.exam_group_navigation_mode" class="invalid-feedback">
                                {{ errors.exam_group_navigation_mode }}
                            </div>
                        </div>

                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label">Durasi Tryout (Dalam Menit Per Sesi atau Per Kolom)</label>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label">Peserta Dapat Mengulangi Tryout</label>
                        ...
                        <div class="col-12" v-if="form.minimal_grade_type == 2">
                            <label class="form-label">Nilai Minimal Yang Ditampilkan (Jika Dikosongkan akan mengambil penilaian sesuai kalkulator penilaian)</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Izinkan Peserta Mencetak Hasil Ujian</label>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1 && $page.props.setting.block_system_type == 1">
                        ...
                        <div class="col-12">
                            <label class="form-label">Status Tryout</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Tanggal Rilis Tryout</label>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                exam_group_navigation_mode: props.examGroup.exam_group_navigation_mode ?? '', 
                ...
                show_ranking_exam: props.examGroup.show_ranking_exam ?? '',
                ...
                exam_start_time: props.examGroup.exam_start_time,
                exam_end_time: props.examGroup.exam_end_time,
                exam_status: props.examGroup.exam_status,
                release_date: props.examGroup.release_date,
                price_type: props.examGroup.price_type,
            ...
            const submit = () => {
                ...
                Inertia.put(`/admin/exam-groups/${props.examGroup.id}`, {
                    ...
                    exam_group_navigation_mode: form.exam_group_navigation_mode,
