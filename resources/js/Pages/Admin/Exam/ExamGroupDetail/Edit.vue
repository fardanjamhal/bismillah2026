            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label">Piih Mode Pengambilan Soal</label>
                        ...
                        <div class="col-12" v-if="examGroup.exam_group_type == 2 && $page.props.setting.block_system_type == 1">
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                question_selection_mode: props.exam.question_selection_mode,
                ...
                show_ranking_exam: props.exam.show_ranking_exam,
