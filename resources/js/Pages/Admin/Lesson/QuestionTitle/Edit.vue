            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12" v-if="(form.assessment_type == 1 || form.assessment_type == 2) && form.add_value_category == 1">
                            <label class="form-label">Kelompok Kategori Penilaian</label>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                value_category_group_id: props.questionTitle.value_category_group_id ?? '',
            ...
            axios.get(`/admin/categories/${form.category_id}/value-category-groups`).then(response => {
            ...
            const submit = () => {
                ...
                Inertia.put(`/admin/question-titles/${props.questionTitle.id}`, {
                    ...
                    assessment_type: form.add_value_category == 0 ? '' : form.assessment_type,
